      ...
      <div className="mx-auto max-w-5xl px-5 py-10">
        ...
        <div className="mt-8 flex flex-wrap gap-3">
          <button
            ...
            onClick={guardar}
            aria-busy={guardando}
            className="etiqueta bg-accent-solid text-accent-ink rounded-md px-6 py-3 hover:opacity-90 transition-[opacity,transform] duration-150 ease-out active:scale-[0.98] disabled:opacity-50 disabled:cursor-progress inline-flex items-center"
          >
