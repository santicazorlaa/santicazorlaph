    ...
    <div className="grid gap-10 lg:grid-cols-[1fr_20rem] items-start">
      ...
      <aside className="border border-line rounded-lg p-5 lg:sticky lg:top-24">
        ...
        <form onSubmit={pagar} className="space-y-3">
          ...
          {/* El más largo de todos los botones del sitio: crea la orden acá y
              después redirige a MercadoPago, así que pueden pasar varios
              segundos con la pantalla quieta. El punto que late es lo que
              sostiene esa espera. */}
          <button
            type="submit"
            disabled={enviando}
